# -*- coding: utf-8 -*-
"""лабораторная_№3_cnn (непредобученные эмбеддинги).py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Y1SH3H2dDZ6zjupQBKzL7k62ttoWT6n2
...
from tensorflow.keras.layers import Dense, Conv1D, MaxPool1D, Dropout, GlobalMaxPool1D, LayerNormalization, GlobalAveragePooling1D, BatchNormalization, GlobalMaxPooling1D, Embedding
...
train_text = pad_sequences(train_text, maxlen=maximum_length, padding='post', truncating='post')
test_text = pad_sequences(test_text, maxlen=maximum_length, padding='post', truncating='post')
...
model = Sequential([
    # Первый сверточный блок
    Conv1D(512, 7, activation='relu', padding='same', input_shape=(768, 1)),
    BatchNormalization(),
    MaxPool1D(2),
    Dropout(0.3),
...
model.fit(train_text, train_labels, batch_size=batch_size,
          epochs=epochs, validation_data=(test_text, test_labels))
