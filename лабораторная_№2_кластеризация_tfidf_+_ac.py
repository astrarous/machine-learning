...
Original file is located at
    https://colab.research.google.com/drive/1Wd8jIJ3W84Ls6rDYYgQlXfb_J0exedec
...
visualizer = KElbowVisualizer(agglomerativeclustering, k=(1,10),size=(1080, 500))
...
for k in K:
    ...
    preds = AModel.fit_predict(X_pca)
