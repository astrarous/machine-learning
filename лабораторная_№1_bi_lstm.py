# -*- coding: utf-8 -*-
"""Лабораторная №1 Bi-LSTM

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1d3WG7c90pyCmmNi-dH4pObzWRSwrpV06
...
from tensorflow.keras.layers import Dense, Embedding, Activation, Bidirectional, LSTM
...
model_bilstm.fit(train_text, train_labels, epochs=10, validation_data=(test_text, test_labels))
...
probability = model_bilstm.predict(test_text)
...
probability = model_bilstm.predict(padded_words)
