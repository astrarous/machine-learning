...
Original file is located at
    https://colab.research.google.com/drive/1rsXvJvV0y358kbgNBttoXxmA03qiiEkR
...
cluster_analyzer = KMeans(n_clusters=7, init='k-means++', random_state=42)
...
"""При "оптимальном" количестве кластеров (3): Silhouette Score: 0.55 Adjusted Rand Index: 0.13

При истинном количестве кластеров (7): Silhouette Score: 0.52 Adjusted Rand Index: 0.18
"""